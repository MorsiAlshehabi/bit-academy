...
('','Mars','6794','227936640','0.1','5567-11-14');
UPDATE sterrenstelsel.planeten t SET t.naam = 'Teenalp' WHERE t.naam LIKE 'Mars' ESCAPE '#' AND t.diameter = 6794 AND t.`Afstand tot de zon` = 227936640 AND t.`massa` = 0 AND t.bezoek_datum IS NULL AND t.id = 6;
DELETE FROM Teenalp
WHERE ESCAPE = 4;